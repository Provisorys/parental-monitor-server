        ...
        try {
            ...
            switch (type) {
                ...
                case 'chatMessage':
                    ...
                    break;
                case 'requestLocation': // PARENT -> SERVER: Pai solicita localização (e possivelmente desliga o áudio)
                ...
                case 'startAudioStream': // PARENT -> SERVER: Pai solicita streaming de áudio (e possivelmente desliga o GPS)
